...
// 0x8477B8
const SHORT CAIAction::PROTECTPOINT = 27;

// 0x8477BA
const SHORT CAIAction::REMOVETRAPS = 28;
...
// 0x8477D4
const SHORT CAIAction::MOVEVIEWPOINT = 49;

// 0x8477D6
const SHORT CAIAction::MOVEVIEWOBJECT = 50;

// 0x8477D8
const SHORT CAIAction::CLICKLBUTTONPOINT = 51;

// 0x8477DA
const SHORT CAIAction::CLICKLBUTTONOBJECT = 52;

// 0x8477DC
const SHORT CAIAction::CLICKRBUTTONPOINT = 53;

// 0x8477DE
const SHORT CAIAction::CLICKRBUTTONOBJECT = 54;

// 0x8477E0
const SHORT CAIAction::DOUBLECLICKLBUTTONPOINT = 55;

// 0x8477E2
const SHORT CAIAction::DOUBLECLICKLBUTTONOBJECT = 56;

// 0x8477E4
const SHORT CAIAction::DOUBLECLICKRBUTTONPOINT = 57;

// 0x8477E6
const SHORT CAIAction::DOUBLECLICKRBUTTONOBJECT = 58;

// 0x8477E8
const SHORT CAIAction::MOVECURSORPOINT = 59;

// 0x8477EA
const SHORT CAIAction::CHANGEAISCRIPT = 60;

// 0x8477EC
const SHORT CAIAction::STARTTIMER = 61;

// 0x8477EE
const SHORT CAIAction::SENDTRIGGER = 62;
...
// 0x847826
const SHORT CAIAction::FOLLOW = 89;
...
// 0x847848
const SHORT CAIAction::SHOUT = 106;

// 0x847850
const SHORT CAIAction::LEAVEAREALUA = 110;

// 0x847854
const SHORT CAIAction::USECONTAINER = 112;
...
// 0x84785C
const SHORT CAIAction::TAKEPARTYITEM = 116;

// 0x84785E
const SHORT CAIAction::TAKEPARTYGOLD = 117;
...
// 0x847894
const SHORT CAIAction::CLOSEDOOR = 144;

// 0x847896
const SHORT CAIAction::PICKLOCK = 145;

// 0x84789C
const SHORT CAIAction::BASHDOOR = 148;

// 0x8478B4
const SHORT CAIAction::APPLYSPELL = 160;

// 0x8478CA
const SHORT CAIAction::GIVEGOLDFORCE = 171;
...
// 0x8478E4
const SHORT CAIAction::RUNAWAYFROMNOINTERRUPT = 184;
...
// 0x8479A4
const SHORT CAIAction::CHUNKCREATURE = 292;
