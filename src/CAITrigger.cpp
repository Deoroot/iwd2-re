...
// 0x847DAA
const SHORT CAITrigger::UNUSABLE = 9;
...
// 0x847E30
const SHORT CAITrigger::ENTERED = CAITRIGGER_ENTERED;

// 0x847E3C
const SHORT CAITrigger::OPENED = CAITRIGGER_OPENED;

// 0x847E3E
const SHORT CAITrigger::CLOSED = CAITRIGGER_CLOSED;

// 0x847E44
const SHORT CAITrigger::DISARMED = CAITRIGGER_DISARMED;

// 0x847E46
const SHORT CAITrigger::UNLOCKED = 87;

// 0x847E56
const SHORT CAITrigger::DISARMFAILED = CAITRIGGER_DISARMFAILED;

// 0x847E78
const SHORT CAITrigger::CLICKED = CAITRIGGER_CLICKED;
