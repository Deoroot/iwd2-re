...
public:
    ...
    /* 0030 */ BYTE m_avClass;
    /* 0031 */ BYTE m_padding;
    /* 0032 */ DWORD m_spellListOffset[CSPELLLIST_NUM_CLASSES][CSPELLLIST_MAX_LEVELS];
    /* 012E */ DWORD m_spellListCount[CSPELLLIST_NUM_CLASSES][CSPELLLIST_MAX_LEVELS];
    /* 022A */ DWORD m_domainListOffset[CSPELLLIST_MAX_LEVELS];
    /* 024E */ DWORD m_domainListCount[CSPELLLIST_MAX_LEVELS];
    /* 0272 */ DWORD m_innateListOffset;
    /* 0276 */ DWORD m_innateListCount;
    /* 027A */ DWORD m_songListOffset;
    /* 027E */ DWORD m_songListCount;
    /* 0282 */ DWORD m_shapeListOffset;
    /* 0286 */ DWORD m_shapeListCount;
    /* 028A */ DWORD m_equipmentListOffset;
    /* 028E */ DWORD m_itemListOffset;
    /* 0292 */ DWORD m_itemListCount;
    /* 0296 */ DWORD m_effectListOffset;
    /* 029A */ DWORD m_effectListCount;
    /* 029E */ RESREF m_dialog;
};
